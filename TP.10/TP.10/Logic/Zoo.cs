...
public class Zoo
{
    ...
    /// Animaux dans le zoo
    /// </summary>
    [DataMember] private List<Animal> _animals;

    /// <summary>
    /// Objet servant a creer un nouvelle animal
    /// </summary>
    [DataMember] private AnimalFactory _factory;
    ...
    public void RemoveAnimal(Animal a) =>_animals.Remove(a);

    /// <summary>
    /// Donne un Array des animaux dans le Zoo
    /// </summary>
    /// <returns>Retourne un array de type Animal</returns>
    public Animal[] ListAnimals() => _animals.ToArray();
    ...
    public string[] ListSpecies() => _factory.ListSpecies();
}